...
type CSOCitadelLobby struct {
	...
	GameMode             *ECitadelGameMode  `protobuf:"varint,4,opt,name=game_mode,json=gameMode,enum=dota.ECitadelGameMode" json:"game_mode,omitempty"`
	...
	ServerState          *ELobbyServerState `protobuf:"varint,8,opt,name=server_state,json=serverState,enum=dota.ELobbyServerState" json:"server_state,omitempty"`
...
type CMsgStartFindingMatchInfo struct {
	...
	MatchMode           *ECitadelMatchMode     `protobuf:"varint,3,opt,name=match_mode,json=matchMode,enum=dota.ECitadelMatchMode" json:"match_mode,omitempty"`
	GameMode            *ECitadelGameMode      `protobuf:"varint,5,opt,name=game_mode,json=gameMode,enum=dota.ECitadelGameMode" json:"game_mode,omitempty"`
	SoloMatch           *bool                  `protobuf:"varint,6,opt,name=solo_match,json=soloMatch" json:"solo_match,omitempty"`
	BotDifficulty       *ECitadelBotDifficulty `protobuf:"varint,7,opt,name=bot_difficulty,json=botDifficulty,enum=dota.ECitadelBotDifficulty" json:"bot_difficulty,omitempty"`
	RegionMode          *ECitadelRegionMode    `protobuf:"varint,8,opt,name=region_mode,json=regionMode,enum=dota.ECitadelRegionMode" json:"region_mode,omitempty"`
}
...
type CMsgRegionPingTimesClient struct {
	...
	DataCenterCodes []uint32 `protobuf:"fixed32,1,rep,name=data_center_codes,json=dataCenterCodes" json:"data_center_codes,omitempty"`
	PingTimes       []uint32 `protobuf:"varint,2,rep,name=ping_times,json=pingTimes" json:"ping_times,omitempty"`
}
...
type CSOCitadelParty struct {
	...
	BotDifficulty         *ECitadelBotDifficulty        `protobuf:"varint,7,opt,name=bot_difficulty,json=botDifficulty,enum=dota.ECitadelBotDifficulty" json:"bot_difficulty,omitempty"`
	MatchMode             *ECitadelMatchMode            `protobuf:"varint,9,opt,name=match_mode,json=matchMode,enum=dota.ECitadelMatchMode" json:"match_mode,omitempty"`
	GameMode              *ECitadelGameMode             `protobuf:"varint,10,opt,name=game_mode,json=gameMode,enum=dota.ECitadelGameMode" json:"game_mode,omitempty"`
	...
	ChatMode              *CSOCitadelParty_EChatMode    `protobuf:"varint,14,opt,name=chat_mode,json=chatMode,enum=dota.CSOCitadelParty_EChatMode" json:"chat_mode,omitempty"`
	RegionMode            *ECitadelRegionMode           `protobuf:"varint,15,opt,name=region_mode,json=regionMode,enum=dota.ECitadelRegionMode" json:"region_mode,omitempty"`
}
...
func (x *CSOCitadelParty) GetChatMode() CSOCitadelParty_EChatMode {
	...
	return CSOCitadelParty_k_eNone
}
...
type CMsgMatchPlayerDamageMatrix struct {
	...
	SampleTimeS   []uint32                                    `protobuf:"varint,2,rep,name=sample_time_s,json=sampleTimeS" json:"sample_time_s,omitempty"`
...
type CSOCitadelParty_Member struct {
	...
	PlayerType           *CSOCitadelParty_EPlayerType `protobuf:"varint,5,opt,name=player_type,json=playerType,enum=dota.CSOCitadelParty_EPlayerType" json:"player_type,omitempty"`
	...
	OwnedHeroes          []uint32                     `protobuf:"varint,12,rep,name=owned_heroes,json=ownedHeroes" json:"owned_heroes,omitempty"`
}
...
func (x *CSOCitadelParty_Member) GetPlayerType() CSOCitadelParty_EPlayerType {
	...
	return CSOCitadelParty_k_ePlayerType_Player
}
...
type CSOCitadelParty_LeftMember struct {
	...
	PlayerType  *CSOCitadelParty_EPlayerType `protobuf:"varint,3,opt,name=player_type,json=playerType,enum=dota.CSOCitadelParty_EPlayerType" json:"player_type,omitempty"`
}
...
type CMsgMatchPlayerPathsData_Path struct {
	...
	XPos       []uint32 `protobuf:"varint,6,rep,name=x_pos,json=xPos" json:"x_pos,omitempty"`
	YPos       []uint32 `protobuf:"varint,7,rep,name=y_pos,json=yPos" json:"y_pos,omitempty"`
	Alive      []bool   `protobuf:"varint,8,rep,name=alive" json:"alive,omitempty"`
	Health     []uint32 `protobuf:"varint,9,rep,name=health" json:"health,omitempty"`
}
...
type CMsgMatchPlayerDamageMatrix_DamageToPlayer struct {
	...
	Damage           []uint32 `protobuf:"varint,2,rep,name=damage" json:"damage,omitempty"`
}
...
type CMsgMatchPlayerDamageMatrix_SourceDetails struct {
	...
	StatType   []CMsgMatchPlayerDamageMatrix_EStatType `protobuf:"varint,1,rep,name=stat_type,json=statType,enum=dota.CMsgMatchPlayerDamageMatrix_EStatType" json:"stat_type,omitempty"`
...
type CMsgMatchMetaDataContents_GoldSource struct {
	...
	Source   *CMsgMatchMetaDataContents_EGoldSource `protobuf:"varint,1,opt,name=source,enum=dota.CMsgMatchMetaDataContents_EGoldSource" json:"source,omitempty"`
...
func (x *CMsgMatchMetaDataContents_GoldSource) GetSource() CMsgMatchMetaDataContents_EGoldSource {
	...
	return CMsgMatchMetaDataContents_k_ePlayers
}
...
type CMsgMatchMetaDataContents_Players struct {
	...
	Team              *ECitadelLobbyTeam                       `protobuf:"varint,6,opt,name=team,enum=dota.ECitadelLobbyTeam" json:"team,omitempty"`
	...
	StatsTypeStat     []float32                                `protobuf:"fixed32,21,rep,name=stats_type_stat,json=statsTypeStat" json:"stats_type_stat,omitempty"`
...
type CMsgMatchMetaDataContents_Objective struct {
	...
	LegacyObjectiveId     *ECitadelObjective     `protobuf:"varint,1,opt,name=legacy_objective_id,json=legacyObjectiveId,enum=dota.ECitadelObjective" json:"legacy_objective_id,omitempty"`
...
func (x *CMsgMatchMetaDataContents_Objective) GetLegacyObjectiveId() ECitadelObjective {
	...
	return ECitadelObjective_k_eCitadelObjective_Team0_Core
}
...
type CMsgMatchMetaDataContents_MatchInfo struct {
	...
	MatchOutcome         *CMsgMatchMetaDataContents_EMatchOutcome        `protobuf:"varint,2,opt,name=match_outcome,json=matchOutcome,enum=dota.CMsgMatchMetaDataContents_EMatchOutcome" json:"match_outcome,omitempty"`
	...
	GameMode             *ECitadelGameMode                               `protobuf:"varint,9,opt,name=game_mode,json=gameMode,enum=dota.ECitadelGameMode" json:"game_mode,omitempty"`
	MatchMode            *ECitadelMatchMode                              `protobuf:"varint,10,opt,name=match_mode,json=matchMode,enum=dota.ECitadelMatchMode" json:"match_mode,omitempty"`
...
func (x *CMsgMatchMetaDataContents_MatchInfo) GetMatchOutcome() CMsgMatchMetaDataContents_EMatchOutcome {
	...
	return CMsgMatchMetaDataContents_k_eOutcome_TeamWin
}
...
var file_citadel_gcmessages_common_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xca, 0x04, 0x0a, 0x0f, 0x43, 0x53, 0x4f, 0x43, 0x69, 0x74, 0x61,
	0x64, 0x65, 0x6c, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x12, 0x19, 0x0a, 0x08, 0x6c, 0x6f, 0x62, 0x62,
	...
	,
	...
	0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x64, 0x6f, 0x74, 0x61, 0x2e,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x06, 0x52, 0x0d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74,
	0x65, 0x61, 0x6d, 0x49, 0x64, 0x12, 0x3a, 0x0a, 0x0c, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x64, 0x6f,
	0x74, 0x61, 0x2e, 0x45, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x52, 0x0b, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x12, 0x24, 0x0a, 0x0e, 0x75, 0x64, 0x70, 0x5f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	0x5f, 0x69, 0x70, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x75, 0x64, 0x70, 0x43, 0x6f,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x72, 0x74, 0x52, 0x07, 0x61, 0x73, 0x73, 0x65, 0x72, 0x74, 0x73, 0x1a, 0x9e, 0x02,
	...
	0x6f, 0x6e, 0x12, 0x2a, 0x0a, 0x11, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x74, 0x69, 0x6d, 0x65,
	0x73, 0x5f, 0x66, 0x69, 0x72, 0x65, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x74,
	0x6f, 0x74, 0x61, 0x6c, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x46, 0x69, 0x72, 0x65, 0x64, 0x22, 0x3c,
	...
	,
	...
	0x33, 0x0a, 0x09, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x0a, 0x20, 0x01,
	...
	,
	...
	0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x1a, 0xfc, 0x03, 0x0a, 0x06, 0x4d,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x6c, 0x6c, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x64, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04,
	0x67, 0x6f, 0x6c, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x67, 0x6f, 0x6c, 0x64,
	0x12, 0x1b, 0x0a, 0x09, 0x67, 0x6f, 0x6c, 0x64, 0x5f, 0x6f, 0x72, 0x62, 0x73, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x08, 0x67, 0x6f, 0x6c, 0x64, 0x4f, 0x72, 0x62, 0x73, 0x1a, 0x38, 0x0a,
	0x12, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x49,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x0b, 0x77, 0x69, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x54, 0x65, 0x61, 0x6d, 0x12, 0x41, 0x0a,
	0x07, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27,
	0x2e, 0x64, 0x6f, 0x74, 0x61, 0x2e, 0x43, 0x4d, 0x73, 0x67, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x4d,
	0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x2e,
	0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x52, 0x07, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73,
	...
	,
	...
	0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x44, 0x65,
	...
	,
	...
	,
...
var file_citadel_gcmessages_common_proto_goTypes = []any{
	(CMsgLaneColor)(0),                                   // 0: dota.CMsgLaneColor
	(EGCCitadelCommonMessages)(0),                        // 1: dota.EGCCitadelCommonMessages
	(ECitadelMatchMode)(0),                               // 2: dota.ECitadelMatchMode
	(ECitadelLobbyTeam)(0),                               // 3: dota.ECitadelLobbyTeam
	(ECitadelAccountStatMedal)(0),                        // 4: dota.ECitadelAccountStatMedal
	(ECitadelObjective)(0),                               // 5: dota.ECitadelObjective
	(ECitadelTeamObjective)(0),                           // 6: dota.ECitadelTeamObjective
	(ECitadelBotDifficulty)(0),                           // 7: dota.ECitadelBotDifficulty
	(ECitadelRegionMode)(0),                              // 8: dota.ECitadelRegionMode
	(ECitadelGameMode)(0),                                // 9: dota.ECitadelGameMode
	(ELobbyServerState)(0),                               // 10: dota.ELobbyServerState
	(CSOCitadelParty_EMemberRights)(0),                   // 11: dota.CSOCitadelParty.EMemberRights
	(CSOCitadelParty_EPlayerType)(0),                     // 12: dota.CSOCitadelParty.EPlayerType
	(CSOCitadelParty_EChatMode)(0),                       // 13: dota.CSOCitadelParty.EChatMode
	(CMsgMatchPlayerDamageMatrix_EStatType)(0),           // 14: dota.CMsgMatchPlayerDamageMatrix.EStatType
	(CMsgMatchMetaDataContents_EMatchOutcome)(0),         // 15: dota.CMsgMatchMetaDataContents.EMatchOutcome
	(CMsgMatchMetaDataContents_EGoldSource)(0),           // 16: dota.CMsgMatchMetaDataContents.EGoldSource
	(*CSOCitadelLobby)(nil),                              // 17: dota.CSOCitadelLobby
	(*CLobbyData_PostMatchSurvey)(nil),                   // 18: dota.CLobbyData_PostMatchSurvey
	(*CMsgHeroSelectionMatchInfo)(nil),                   // 19: dota.CMsgHeroSelectionMatchInfo
	(*CMsgStartFindingMatchInfo)(nil),                    // 20: dota.CMsgStartFindingMatchInfo
	(*CMsgAnyToGCReportAsserts)(nil),                     // 21: dota.CMsgAnyToGCReportAsserts
	(*CMsgAnyToGCReportAssertsResponse)(nil),             // 22: dota.CMsgAnyToGCReportAssertsResponse
	(*CMsgRegionPingTimesClient)(nil),                    // 23: dota.CMsgRegionPingTimesClient
	(*CSOCitadelParty)(nil),                              // 24: dota.CSOCitadelParty
	(*CMsgMatchPlayerPathsData)(nil),                     // 25: dota.CMsgMatchPlayerPathsData
	(*CMsgMatchPlayerDamageMatrix)(nil),                  // 26: dota.CMsgMatchPlayerDamageMatrix
	(*CMsgMatchMetaDataContents)(nil),                    // 27: dota.CMsgMatchMetaDataContents
	(*CMsgMatchMetaData)(nil),                            // 28: dota.CMsgMatchMetaData
	(*CMsgMapLine)(nil),                                  // 29: dota.CMsgMapLine
	(*CMsgAccountHeroStats)(nil),                         // 30: dota.CMsgAccountHeroStats
	(*CMsgAccountBookStats)(nil),                         // 31: dota.CMsgAccountBookStats
	(*CMsgAccountStats)(nil),                             // 32: dota.CMsgAccountStats
	(*CLobbyData_PostMatchSurvey_PlayerSurvey)(nil),      // 33: dota.CLobbyData_PostMatchSurvey.PlayerSurvey
	(*CMsgHeroSelectionMatchInfo_Hero)(nil),              // 34: dota.CMsgHeroSelectionMatchInfo.Hero
	(*CMsgAnyToGCReportAsserts_TrackedAssert)(nil),       // 35: dota.CMsgAnyToGCReportAsserts.TrackedAssert
	(*CSOCitadelParty_Member)(nil),                       // 36: dota.CSOCitadelParty.Member
	(*CSOCitadelParty_LeftMember)(nil),                   // 37: dota.CSOCitadelParty.LeftMember
	(*CSOCitadelParty_Invite)(nil),                       // 38: dota.CSOCitadelParty.Invite
	(*CMsgMatchPlayerPathsData_Path)(nil),                // 39: dota.CMsgMatchPlayerPathsData.Path
	(*CMsgMatchPlayerDamageMatrix_DamageToPlayer)(nil),   // 40: dota.CMsgMatchPlayerDamageMatrix.DamageToPlayer
	(*CMsgMatchPlayerDamageMatrix_DamageSource)(nil),     // 41: dota.CMsgMatchPlayerDamageMatrix.DamageSource
	(*CMsgMatchPlayerDamageMatrix_DamageDealer)(nil),     // 42: dota.CMsgMatchPlayerDamageMatrix.DamageDealer
	(*CMsgMatchPlayerDamageMatrix_SourceDetails)(nil),    // 43: dota.CMsgMatchPlayerDamageMatrix.SourceDetails
	(*CMsgMatchMetaDataContents_Position)(nil),           // 44: dota.CMsgMatchMetaDataContents.Position
	(*CMsgMatchMetaDataContents_Deaths)(nil),             // 45: dota.CMsgMatchMetaDataContents.Deaths
	(*CMsgMatchMetaDataContents_Items)(nil),              // 46: dota.CMsgMatchMetaDataContents.Items
	(*CMsgMatchMetaDataContents_Ping)(nil),               // 47: dota.CMsgMatchMetaDataContents.Ping
	(*CMsgMatchMetaDataContents_GoldSource)(nil),         // 48: dota.CMsgMatchMetaDataContents.GoldSource
	(*CMsgMatchMetaDataContents_CustomUserStatInfo)(nil), // 49: dota.CMsgMatchMetaDataContents.CustomUserStatInfo
	(*CMsgMatchMetaDataContents_CustomUserStat)(nil),     // 50: dota.CMsgMatchMetaDataContents.CustomUserStat
	(*CMsgMatchMetaDataContents_PlayerStats)(nil),        // 51: dota.CMsgMatchMetaDataContents.PlayerStats
	(*CMsgMatchMetaDataContents_AbilityStat)(nil),        // 52: dota.CMsgMatchMetaDataContents.AbilityStat
	(*CMsgMatchMetaDataContents_BookReward)(nil),         // 53: dota.CMsgMatchMetaDataContents.BookReward
	(*CMsgMatchMetaDataContents_Players)(nil),            // 54: dota.CMsgMatchMetaDataContents.Players
	(*CMsgMatchMetaDataContents_Objective)(nil),          // 55: dota.CMsgMatchMetaDataContents.Objective
	(*CMsgMatchMetaDataContents_MidBoss)(nil),            // 56: dota.CMsgMatchMetaDataContents.MidBoss
	(*CMsgMatchMetaDataContents_Pause)(nil),              // 57: dota.CMsgMatchMetaDataContents.Pause
	(*CMsgMatchMetaDataContents_WatchedDeathReplay)(nil), // 58: dota.CMsgMatchMetaDataContents.WatchedDeathReplay
	(*CMsgMatchMetaDataContents_MatchInfo)(nil),          // 59: dota.CMsgMatchMetaDataContents.MatchInfo
	(*CExtraMsgBlock)(nil),                               // 60: dota.CExtraMsgBlock
	(EGCPlatform)(0),                                     // 61: dota.EGCPlatform
}
var file_citadel_gcmessages_common_proto_depIdxs = []int32{
	2,  // 0: dota.CSOCitadelLobby.match_mode:type_name -> dota.ECitadelMatchMode
	9,  // 1: dota.CSOCitadelLobby.game_mode:type_name -> dota.ECitadelGameMode
	60, // 2: dota.CSOCitadelLobby.extra_messages:type_name -> dota.CExtraMsgBlock
	10, // 3: dota.CSOCitadelLobby.server_state:type_name -> dota.ELobbyServerState
	33, // 4: dota.CLobbyData_PostMatchSurvey.surveys:type_name -> dota.CLobbyData_PostMatchSurvey.PlayerSurvey
	34, // 5: dota.CMsgHeroSelectionMatchInfo.hero_selections:type_name -> dota.CMsgHeroSelectionMatchInfo.Hero
	2,  // 6: dota.CMsgStartFindingMatchInfo.match_mode:type_name -> dota.ECitadelMatchMode
	9,  // 7: dota.CMsgStartFindingMatchInfo.game_mode:type_name -> dota.ECitadelGameMode
	7,  // 8: dota.CMsgStartFindingMatchInfo.bot_difficulty:type_name -> dota.ECitadelBotDifficulty
	8,  // 9: dota.CMsgStartFindingMatchInfo.region_mode:type_name -> dota.ECitadelRegionMode
	35, // 10: dota.CMsgAnyToGCReportAsserts.asserts:type_name -> dota.CMsgAnyToGCReportAsserts.TrackedAssert
	36, // 11: dota.CSOCitadelParty.members:type_name -> dota.CSOCitadelParty.Member
	38, // 12: dota.CSOCitadelParty.invites:type_name -> dota.CSOCitadelParty.Invite
	37, // 13: dota.CSOCitadelParty.left_members:type_name -> dota.CSOCitadelParty.LeftMember
	7,  // 14: dota.CSOCitadelParty.bot_difficulty:type_name -> dota.ECitadelBotDifficulty
	2,  // 15: dota.CSOCitadelParty.match_mode:type_name -> dota.ECitadelMatchMode
	9,  // 16: dota.CSOCitadelParty.game_mode:type_name -> dota.ECitadelGameMode
	13, // 17: dota.CSOCitadelParty.chat_mode:type_name -> dota.CSOCitadelParty.EChatMode
	8,  // 18: dota.CSOCitadelParty.region_mode:type_name -> dota.ECitadelRegionMode
	39, // 19: dota.CMsgMatchPlayerPathsData.paths:type_name -> dota.CMsgMatchPlayerPathsData.Path
	42, // 20: dota.CMsgMatchPlayerDamageMatrix.damage_dealers:type_name -> dota.CMsgMatchPlayerDamageMatrix.DamageDealer
	43, // 21: dota.CMsgMatchPlayerDamageMatrix.source_details:type_name -> dota.CMsgMatchPlayerDamageMatrix.SourceDetails
	59, // 22: dota.CMsgMatchMetaDataContents.match_info:type_name -> dota.CMsgMatchMetaDataContents.MatchInfo
	30, // 23: dota.CMsgAccountStats.stats:type_name -> dota.CMsgAccountHeroStats
	12, // 24: dota.CSOCitadelParty.Member.player_type:type_name -> dota.CSOCitadelParty.EPlayerType
	61, // 25: dota.CSOCitadelParty.Member.platform:type_name -> dota.EGCPlatform
	19, // 26: dota.CSOCitadelParty.Member.hero_roster:type_name -> dota.CMsgHeroSelectionMatchInfo
	12, // 27: dota.CSOCitadelParty.LeftMember.player_type:type_name -> dota.CSOCitadelParty.EPlayerType
	40, // 28: dota.CMsgMatchPlayerDamageMatrix.DamageSource.damage_to_players:type_name -> dota.CMsgMatchPlayerDamageMatrix.DamageToPlayer
	41, // 29: dota.CMsgMatchPlayerDamageMatrix.DamageDealer.damage_sources:type_name -> dota.CMsgMatchPlayerDamageMatrix.DamageSource
	14, // 30: dota.CMsgMatchPlayerDamageMatrix.SourceDetails.stat_type:type_name -> dota.CMsgMatchPlayerDamageMatrix.EStatType
	44, // 31: dota.CMsgMatchMetaDataContents.Deaths.death_pos:type_name -> dota.CMsgMatchMetaDataContents.Position
	44, // 32: dota.CMsgMatchMetaDataContents.Deaths.killer_pos:type_name -> dota.CMsgMatchMetaDataContents.Position
	16, // 33: dota.CMsgMatchMetaDataContents.GoldSource.source:type_name -> dota.CMsgMatchMetaDataContents.EGoldSource
	48, // 34: dota.CMsgMatchMetaDataContents.PlayerStats.gold_sources:type_name -> dota.CMsgMatchMetaDataContents.GoldSource
	50, // 35: dota.CMsgMatchMetaDataContents.PlayerStats.custom_user_stats:type_name -> dota.CMsgMatchMetaDataContents.CustomUserStat
	45, // 36: dota.CMsgMatchMetaDataContents.Players.death_details:type_name -> dota.CMsgMatchMetaDataContents.Deaths
	46, // 37: dota.CMsgMatchMetaDataContents.Players.items:type_name -> dota.CMsgMatchMetaDataContents.Items
	51, // 38: dota.CMsgMatchMetaDataContents.Players.stats:type_name -> dota.CMsgMatchMetaDataContents.PlayerStats
	3,  // 39: dota.CMsgMatchMetaDataContents.Players.team:type_name -> dota.ECitadelLobbyTeam
	47, // 40: dota.CMsgMatchMetaDataContents.Players.pings:type_name -> dota.CMsgMatchMetaDataContents.Ping
	52, // 41: dota.CMsgMatchMetaDataContents.Players.ability_stats:type_name -> dota.CMsgMatchMetaDataContents.AbilityStat
	53, // 42: dota.CMsgMatchMetaDataContents.Players.book_rewards:type_name -> dota.CMsgMatchMetaDataContents.BookReward
	5,  // 43: dota.CMsgMatchMetaDataContents.Objective.legacy_objective_id:type_name -> dota.ECitadelObjective
	6,  // 44: dota.CMsgMatchMetaDataContents.Objective.team_objective_id:type_name -> dota.ECitadelTeamObjective
	3,  // 45: dota.CMsgMatchMetaDataContents.Objective.team:type_name -> dota.ECitadelLobbyTeam
	3,  // 46: dota.CMsgMatchMetaDataContents.MidBoss.team_killed:type_name -> dota.ECitadelLobbyTeam
	3,  // 47: dota.CMsgMatchMetaDataContents.MidBoss.team_claimed:type_name -> dota.ECitadelLobbyTeam
	15, // 48: dota.CMsgMatchMetaDataContents.MatchInfo.match_outcome:type_name -> dota.CMsgMatchMetaDataContents.EMatchOutcome
	3,  // 49: dota.CMsgMatchMetaDataContents.MatchInfo.winning_team:type_name -> dota.ECitadelLobbyTeam
	54, // 50: dota.CMsgMatchMetaDataContents.MatchInfo.players:type_name -> dota.CMsgMatchMetaDataContents.Players
	9,  // 51: dota.CMsgMatchMetaDataContents.MatchInfo.game_mode:type_name -> dota.ECitadelGameMode
	2,  // 52: dota.CMsgMatchMetaDataContents.MatchInfo.match_mode:type_name -> dota.ECitadelMatchMode
	55, // 53: dota.CMsgMatchMetaDataContents.MatchInfo.objectives:type_name -> dota.CMsgMatchMetaDataContents.Objective
	25, // 54: dota.CMsgMatchMetaDataContents.MatchInfo.match_paths:type_name -> dota.CMsgMatchPlayerPathsData
	26, // 55: dota.CMsgMatchMetaDataContents.MatchInfo.damage_matrix:type_name -> dota.CMsgMatchPlayerDamageMatrix
	57, // 56: dota.CMsgMatchMetaDataContents.MatchInfo.match_pauses:type_name -> dota.CMsgMatchMetaDataContents.Pause
	49, // 57: dota.CMsgMatchMetaDataContents.MatchInfo.custom_user_stats:type_name -> dota.CMsgMatchMetaDataContents.CustomUserStatInfo
	58, // 58: dota.CMsgMatchMetaDataContents.MatchInfo.watched_death_replays:type_name -> dota.CMsgMatchMetaDataContents.WatchedDeathReplay
	56, // 59: dota.CMsgMatchMetaDataContents.MatchInfo.mid_boss:type_name -> dota.CMsgMatchMetaDataContents.MidBoss
